<template>
  <!-- todo: fix absolute and -mt -->
  <svg
    id="ad1dd13e-2ec4-4c24-88e7-d38d592282c0"
    ref="rootey"
    class="relative w-full h-auto max-w-xs mx-auto lg:-mt-56 lg:absolute lg:ml-40 md:max-w-md"
    data-name="Layer 1"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 600 750"
  >
    <!-- old viewBox="0 0 578 675" -->
    <path
    ...
    <circle cx="505" cy="602" r="73" fill="#f9a826" class="floating" />
    <polygon
      class="floating"
