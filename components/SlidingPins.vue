<template>
    <div class="m-10 mx-auto py-10 px-16 sm:px-24 lg:px-64 bg-gray-200">
    ...
    <div class="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl" style="min-height: 19rem;">
      <div class="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg" style="min-height: 19rem;">
        ...
        <div class="absolute inset-0 w-full h-full bg-gradient-to-b from-blue-950 to-blue-800 opacity-75 rounded-tl-lg"></div>
        <div class="absolute inset-0 w-full h-full flex items-center justify-center fill-current text-white">
          ...
          <img class="w-40 h-40 aspect-square ml-0 mt-0" src="GlitterPin.png">
        </div>
        
      </div>
      <div class="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
        <div class="p-12 md:pr-24 md:pl-16 md:py-12">
          <p class="text-gray-600"><span class="text-gray-900">Custom gold lapel pins</span> for the free mason collective. It features a jewelry backing, velvet bag, and multiple variations based off which member it belongs to. Click below to create your own.</p>
          <a class="flex items-baseline mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900" href="">
            <span>Learn more about polished gold</span>
