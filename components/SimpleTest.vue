<template>
  <div class="bg-blue-800">
    <div class="mx-auto max-w-screen-xl md:grid md:grid-cols-2 md:px-6 lg:px-8">
      <div class="px-4 py-12 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-blue-900 lg:pr-16">
        ...
        <blockquote class="mt-8 md:flex-grow md:flex md:flex-col">
          <div class="relative text-lg font-medium text-white leading-7 md:flex-grow">
            <svg class="absolute top-0 left-0 w-8 h-8 text-blue-600 transform -translate-x-3 -translate-y-2" fill="currentColor" viewBox="0 0 32 32">
              <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
            </svg>
            <p class="relative antialiased">
              I highly recommend Lapel Pins and Coins! The service is exceptional. They responded quickly and were very prompt in fixing what I wanted changed on the proof work. The whole process was user friendly and hassle free.
            </p>
          </div>
          <footer class="mt-8">
            <div class="flex">
              ...
              <div class="ml-4">
                <div class="text-base antialiased font-medium text-white leading-6">
                  Sandy Barnett
                </div>
                <div class="text-base antialiased font-medium text-blue-200 leading-6">
                  CEO, Tuple
                </div>
              </div>
            </div>
      ...
      <div class="px-4 py-12 border-t-2 border-blue-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
        ...
        <blockquote class="mt-8 md:flex-grow md:flex md:flex-col">
          <div class="relative text-lg font-medium text-white leading-7 md:flex-grow">
            ...
            <p class="relative antialiased">
              Cori was great to work with on my keychain for my nonprofit. The final product came out way better than expected. I highly recommend Lapel Pins and Coins. Thank you!
            </p>
          </div>
          <footer class="mt-8">
            <div class="flex">
              ...
              <div class="ml-4">
                <div class="text-base font-medium text-white leading-6">
                  Aaron Deglow
                </div>
                <div class="text-base font-medium text-blue-200 leading-6">
                  Founder, Win-Win Charity
                </div>
              </div>
            </div>
          </footer>
