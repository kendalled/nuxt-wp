        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          <div class="mx-4 overflow-hidden rounded-md shadow sm:mx-0">
            ...
            <div class="px-4 py-3 text-right bg-gray-50 sm:px-6">
              ...
              <button v-else :disabled="!!quantityError" type="submit" class="text-white bg-blue-600 hover:bg-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 focus:bg-blue-500 active:bg-blue-600 px-4 py-2 ml-2 text-sm font-medium transition duration-150 ease-in-out border border-transparent rounded-md shadow-sm focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed" @click.prevent="submitHandler">
                Submit Quote
              </button>
            </div>
          </div>
