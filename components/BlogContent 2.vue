...
export default {
  ...
  methods: {
    generateTableOfContents() {
      if (process.client) {
        // Only look for headings within the main article content
...
<style>
/* Clean Typography Styles - Inspired by documentation design */
.prose-blue h1 {
  @apply text-3xl font-bold text-gray-900 mb-3 mt-0;
}
...
.prose-blue h3 {
  @apply text-xl font-semibold text-gray-900 mb-4 mt-10;
}

.prose-blue h4 {
  @apply text-lg font-semibold text-gray-900 mb-3 mt-8;
}

.prose-blue p {
  @apply text-gray-700 leading-7 mb-6 text-base;
}

.prose-blue a {
  @apply text-gray-700 hover:text-gray-900 font-medium no-underline hover:underline transition-all duration-200;
}
...
.prose-blue li {
  @apply mb-2 text-gray-700 leading-7;
}
...
/* Better list spacing for nested content */
.prose-blue li > p {
  @apply mb-2;
}
...
.prose-blue blockquote p {
  @apply text-blue-900 font-medium italic mb-0 text-base;
}

.prose-blue img {
  @apply rounded-lg shadow-lg my-10;
}
