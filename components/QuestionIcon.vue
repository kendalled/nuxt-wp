<template>
  <div @keydown.escape="shown = false">
    <button ref="questionicon" class="hidden ml-2 text-gray-300 transition-colors duration-150 md:block focus:outline-none hover:text-gray-400 focus:text-gray-400" aria-roledescription="Opens description modal" name="Opens description modal" @click.prevent="toggleShown">
